						...
						<li class="current">
							...
							<div class="submenu">
								<ul>
									...
									<li><a href="https://demo.artureanec.com/html/agricom/style_2/index.html" target="_blank">Home Style 2</a></li>
									<li><a href="https://demo.artureanec.com/html/agricom/landing/index.html" target="_blank">One Page</a></li>
								</ul>
							</div>
						</li>
						<li>
							...
							<div class="container">
								<div class="row justify-content-center text-center">
									<div class="col-12 col-xl-10">
										...
										<p class="subtitle">
											Durabilité, Solidarité, Impact
										</p>

										<p>
											<a class="custom-btn big primary" href="#">Démarrer une activité</a>
										</p>
									</div>
								</div>
							</div>
							...
							jQuery(document).ready(function($){
								...
								var slider = $('#vegas-slider'),
									slides = [
										{
											name: "img 1",
											src: '../assets2/img/home_img/img_1.jpg'
										},
										{
											name: "img 2",
											src: '../assets2/img/home_img/img_2.jpg'
										},
										{
											name: "img 3",
											src: '../assets2/img/home_img/img_3.jpg'
										}
									],
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-12 col-lg-8 col-xl-9">
							<div class="col-MB-30">
								<h4>
									AGROMAX est un complexe agro-industriel  basé sur une plateforme collaborative en ligne à forte valeur ajoutée socio-économique.
								</h4>

								<p>
									La plateforme vous offre la possibilité de partager des ressources et des connaissances, ainsi que de collaborer sur des projets agricoles axés sur des valeurs de Durabilité, de Solidarité, et d’Impact multidimensionnel.
Les utilisateurs peuvent créer leur propre ferme virtuelle en utilisant des outils interactifs, tels que des cartes et des diagrammes, pour planifier leurs activités ou leur investissement.

Même virtuelles, vos fermes sont conçues pour être rentables, en utilisant des techniques agricoles innovantes, telles que l'agriculture de précision et l’élevage dynamique  pour maximiser la production et minimiser les coûts. Les utilisateurs peuvent également accéder à des fonctionnalités de marketing intégrées pour vendre leurs produits agricoles en ligne.

Votre application d'agrobusiness collaboratif offre une solution innovante pour les personnes intéressées par l’élevage, le maraîchage et
			 l'agriculture , mais ne disposant pas de temps pratique, ni de terres agricoles ou de connaissances spécialisées. Elle permet également de promouvoir l'agriculture durable et de renforcer les capacités de transformation agroalimentaire de notre pays pour le grand bonheur de l’économie globale du pays.
								</p>
							</div>
									...
									<div class="row justify-content-between">
										...
										<div class="col">
											<div class="feature__item">
												...
												<h3 class="feature__item__title  h4">Plateforme simple <br />et sécurisée</h3>
											</div>
										</div>
										<!-- end item -->
									</div>
			...
			<section class="section section--no-pt section--custom-1">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<div class="col-MB-30">
								<img class="img-fluid" src="../assets2/img/slogan.png" alt="demo" />
							</div>
						</div>
					</div>
				</div>
			...
			<section class="section section--custom-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							...
							<p class="d-lg-none"><img class="img-fluid" src="../assets2/img/img_7.jpg" alt="demo" /></p>
				...
				<div class="img-place" style="background-image: url(../assets2/img/img_7.jpg);"></div>
			</section>
			<!-- end section -->
							...
							<div class="row no-gutters">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/2.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/3.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/3.jpg" data-gallery="gall">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/4.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/4.jpg" data-gallery="gall">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/5.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/5.jpg" data-gallery="gall">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/6.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/6.jpg#" data-gallery="gall">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/7.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/7.jpg" data-gallery="gall">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../assets2/img/blank.gif" style="background-image: url('../assets2/img/gall_img/4_col/8.jpg');" alt="demo" />

												<a class="gallery__item__description" href="../assets2/img/gall_img/4_col/8.jpg" data-gallery="gall">
									...
									<article class="feedback__item">
										<div class="feedback__author">
											<div class="feedback__author__photo  mx-auto">
												<img class="circled  img-fluid" src="../assets2/img/users_photos/4.png" height="140" width="140" alt="demo" />
											</div>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-12 col-md-6 bg-2">
							<div class="item">
								<header class="item__header">
									<h2 class="item__title">Créer une ferme</h2>
						...
						<div class="col-12">
							<div class="item map-container">
								<div class="g_map" data-longitude="44.958309" data-latitude="34.109925" data-marker="../assets2/img/marker.png"></div>
							</div>
						</div>
					</div>
				</div>
