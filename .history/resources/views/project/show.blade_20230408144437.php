                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">Nom du projet</a>
                            <a href="#">
        ...
        <div class="card-body p-9">
            ...
            <div class="row mb-8">
                ...
                <div class="col-xl-9 fv-row">
                    <input disabled type="text" class="form-control form-control-solid" name="name" value="9 Degree Award" />
                </div>
            </div>
            <!--end::Row-->
