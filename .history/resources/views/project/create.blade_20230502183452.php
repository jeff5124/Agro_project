            ...
            <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="nombre" class="form-control form-control-lg form-control-solid" value="0"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="age" class="form-control form-control-lg form-control-solid" value="0"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="race" class="form-control form-control-lg form-control-solid" value="Noir"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input name="race" class="form-control form-control-lg form-control-solid" value="Femelle"/>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
            ...
            <!--begin::Wrapper-->
                <div class="w-100">
                    ...
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <input id="_show"  disabled type="text" class="form-control form-control-solid" placeholder="" value=""/>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-10">
                        ...
                        <!--end::Col-->
                         ...
                         <div class="col-md-6 fv-row">
                            ...
                            <div class="position-relative">
                                <!--begin::Input-->
                                <input id="_show" disabled type="text" class="form-control form-control-solid" minlength="3" maxlength="4" placeholder="CVV" name="card_cvv"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Input wrapper-->
                        </div>
