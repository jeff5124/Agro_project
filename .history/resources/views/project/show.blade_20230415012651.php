...
<div class="card">
    ...
    <form id="kt_project_settings_form" method="POST" action="{{route('project.edit')}}"class="form">
        @csrf
        <input hidden type="text" value="{{$project->id}}">
        <!--begin::Card body-->
        <div class="card-body p-9">
            ...
            <div class="row mb-8">
                 <!--begin::Col-->
                <div class="col-xl-3">
                    <div class="fs-6 fw-semibold mt-2 mb-3">Nom du projet</div>
                </div>
                <!--end::Col-->

                 <!--begin::Col-->
                <div class="col-xl-9 fv-row">
                    <input  type="text" class="form-control form-control-solid" name="name" value="{{$project->name}}" />
                </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-8">
                 <!--begin::Col-->
                <div class="col-xl-3">
                    <div class="fs-6 fw-semibold mt-2 mb-3">Race</div>
                </div>
                <!--end::Col-->

                 <!--begin::Col-->
                <div class="col-xl-9 fv-row">
                    <input type="text" class="form-control form-control-solid" name="race" value="{{$project->race}}" />
                </div>
            </div>
            <!--end::Row-->
            ...
            <div class="row mb-8">
                ...
                <!--end::Col-->
                 ...
                 <!--begin::Col-->
                <div class="col-xl-9 fv-row">
                    <textarea name="note" class="form-control form-control-solid h-100px">
                        {{$project->note}}
                    </textarea>
                </div>
                 <!--begin::Col-->
            ...
            <div class="row mb-8">
                ...
                <div class="col-xl-9 fv-row">
                    <div class="position-relative d-flex align-items-center">
                        ...
                        <!--end::Svg Icon-->
                        <input type="date" class="form-control form-control-solid ps-12" name="start_at" placeholder="Pick a date" id="kt_datepicker_1" />
                    </div>
                </div>
                <!--begin::Col-->
            </div>
