                ...
                <a href="{{route('project.show',$project->id)}}" >
                    ...
                    <div class="card-header border-0 pt-9">
                        ...
                        <div class="card-toolbar">
                            ...
                            @else
                                @if($project->validate_at != null && $project->start_at == null)
                                    <span class="badge badge-light-primary fw-bold me-auto px-4 py-3">Projet validé mais pas encore commencé</span>
                                @endif
                                <span class="badge badge-light-primary fw-bold me-auto px-4 py-3">Projet en attente de validation</span>
                            @endif
                            {{}}
                        </div>
                        <!--end::Card toolbar-->
