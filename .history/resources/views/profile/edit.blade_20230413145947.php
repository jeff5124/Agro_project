            ...
            <div class="d-flex flex-wrap align-items-center mb-10">
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    ...
                    <form id="kt_signin_change_password" method="post" action="{{ route('password.update') }}" class="form" novalidate="novalidate">
                        ...
                        <div class="d-flex">
                            <button id="kt_password_submit" type="submit" class="btn btn-primary me-2 px-6">Sauvegarder</button>
                            <button id="kt_password_cancel" type="button" class="btn btn-color-gray-400 btn-active-light-primary px-6">Fermer</button>
                        </div>
                    </form>
                    <!--end::Form-->
                </div>
