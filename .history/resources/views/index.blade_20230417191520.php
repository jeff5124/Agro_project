...
<head>
		...
		<!-- CSS
		================================================== -->
		<link rel="stylesheet" href="{{asset('asset2/css/style.min.css')}}" type="text/css">
...
Votre application d'agrobusiness collaboratif offre une solution innovante pour les personnes intéressées par l’élevage, le maraîchage et
			...
			<section class="section section--custom-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							...
							<p class="d-lg-none"><img class="img-fluid" src="../img/img_7.jpg" alt="demo" /></p>
				...
				<div class="img-place" style="background-image: url(../img/img_7.jpg);"></div>
			</section>
			<!-- end section -->
							...
							<div class="row no-gutters">
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/2.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/3.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/4.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/5.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/6.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/7.jpg');" alt="demo" />
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3">
									<div class="gallery__item">
										<div class="gallery__item__inner">
											<figure>
												<img src="../img/blank.gif" style="background-image: url('../img/gall_img/4_col/8.jpg');" alt="demo" />
		...
		<script src="{{asset('asset2/ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js')}}"></script>
		<script>window.jQuery || document.write('<script src="../js/jquery-2.2.4.min.js"><\/script>')</script>

		<script type="text/javascript" src="{{asset('asset2/js/main.min.js')}}"></script>
