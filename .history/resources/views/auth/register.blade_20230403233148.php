...
<!--begin::Form-->
<form action="" class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo1/../demo1/authentication/layouts/overlay/sign-in.html" action="post">
    <!--begin::Heading-->
