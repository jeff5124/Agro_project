...
<!--begin::Form-->
<form action="{{ route('register') }}" class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo1/../demo1/authentication/layouts/overlay/sign-in.html" action="post">
    <!--begin::Heading-->
    ...
    <div class="fv-row mb-8">
        <!--begin::Name-->
        <input type="text" placeholder="Nom et prénoms" name="name" autocomplete="off" class="form-control bg-transparent"/>
        <!--end::Name-->
    </div>
    <div class="fv-row mb-8">
        <!--begin::Email-->
    ...
    <div class="fv-row mb-8">
        ...
        <input type="text" placeholder="Confirmer mot de passe" name="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent"/>
        <!--end::Repeat Password-->
    </div>
    <!--end::Input group--->
