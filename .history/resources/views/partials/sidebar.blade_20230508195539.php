<div id="kt_app_sidebar" class="app-sidebar  flex-column "
    ...
    <!--begin::Logo-->
        ...
        <!--begin::Logo image-->
        <a href="{{route("index")}}">
            <img alt="Logo" src="{{asset('assets/media/logos/Logo-AgroMaxWhite.png')}}" class="h-100px app-sidebar-logo-default"/>
        ...
        <a class="menu-link"  href="{{Route('project.index')}}" >
            <span  class="menu-icon" >
               ...
               {{--  <span class="svg-icon
                ...
                <span class="svg-icon">
                    <img  width="24" height="24" src="{{asset("assets2/img/Icons_AgroMax/projet.png")}}" alt="">
