<div id="kt_app_sidebar" class="app-sidebar  flex-column "
    ...
    <!--begin::Logo-->
        ...
        <!--begin::Logo image-->
        <a href="{{route("index")}}">
            <img alt="Logo" src="{{asset('assets/media/logos/Logo-AgroMaxWhite.png')}}" class="h-50px app-sidebar-logo-default"/>
    ...
    <a class="menu-link"  href="{{Route('welcome')}}" >
        <span  class="menu-icon" >
            ...
            <span class="svg-icon svg-icon-3">
                <img  width="24" height="24" src="{{asset("assets/media/icons/sidebar/accueil.png")}}" alt="">
            </span>
            <!--end::Svg Icon-->
        </span>
        ...
        <div  class="menu-item" >
            ...
            <a class="menu-link"  href="{{Route('project.create')}}" >
                <span  class="menu-icon" >
                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                    <span class="svg-icon svg-icon-3">
                        <img  width="24" height="24" src="{{asset("assets/media/icons/sidebar/projet.png")}}" alt="">
                    </span>
                    <!--end::Svg Icon-->
                </span>
    ...
    <div  class="menu-item" >
        ...
        <a class="menu-link"  href="{{Route('project.index')}}" >
            <span  class="menu-icon" >
                <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
               {{--  <span class="svg-icon
                 svg-icon-2"><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span class="svg-icon">
                    <img  width="24" height="24" src="{{asset("assets/media/icons/sidebar/portefeuille.png")}}" alt="">
                </span>
            </span>
...
<<<<<<< HEAD
        <a class="menu-link"  href="{{Route('espece.index')}}" ><span  class="menu-icon" ><!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
            <span class="svg-icon svg-icon-2">
                <img  width="24" height="24" src="{{asset("assets/media/icons/sidebar/guide.png")}}" alt="">
            </span>
            <!--end::Svg Icon--></span>
            <span  class="menu-title" >Guide</span>
=======
        <a class="menu-link"  href="{{Route('espece.index2')}}" ><span  class="menu-icon" ><!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
...
>>>>>>> 0060b6cd5f75c6fa65ce2dc37ba70bdfdf404f08
        </a>
        <!--end:Menu link-->
    </div>
    <!--end:Menu item-->
