...
<head>
	...
	<body class="page page-home">
		...
		<div id="top-bar" class="top-bar--style-1">
			<div class="container">
				<a id="top-bar__logo" class="site-logo" href="index.html">AGROMAX</a>
				...
				<div class="container">
					<div class="row">
						<div class="col-12 col-lg-4 col-xl-3">
							<div class="col-MB-30">
								<h2>AgroMax Farm Ecology Products</h2>
							</div>
						</div>
						...
						<div class="col-12 col-lg-8 col-xl-9">
							<div class="col-MB-30">
								...
								<p>La plateforme permet à L’utilisateur de créer gratuitement un compte et de démarrer une ferme virtuelle. Simple d’utilisation et sécurisée, notre application web et mobile permet donc à l’utilisateur d’initier, selon son budget, un ou plusieurs projets  dans d’élevage, de maraîchage ou d’agriculture, de suivre son investissement en temps réels de revendre ses produits à notre département transformation ou directement sur notre marketplace sous sa propre enseigne commerciale avec l’appui marketing necessaire.
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							<div class="footer__item">
								<a class="site-logo" href="index.html">AGROMAX</a>

								<p class="footer__copy">© 2023, Agricom. All rights reserved.</p>
							</div>
						</div>
