        ...
        <div class="row">
            <div class="card card-flush overflow-hidden h-xl-100">
                ...
                <div class="card-header pt-7 mb-2">
                    <!--begin::Title-->
                    <h3 class="card-title text-gray-800 fw-bold">Historique</h3>
                    <!--end::Title-->
                ...
                <div class="card-body d-flex justify-content-between flex-column pt-0 pb-1 px-0">
                    ...
                    <div class="px-9 mb-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="badge badge-success fs-base">
                                ...
                                <span class="svg-icon svg-icon-5 svg-icon-white ms-n1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!--end::Info-->
                    <!--begin::Chart-->
                    <div id="kt_charts_widget_26" class="min-h-auto ps-4 pe-6" data-kt-chart-info="Projets" style="height: 300px"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Card body-->
            </div>
