...
<div class="card card-flush py-4">
    ...
    <!--end::Card header-->
    <form id="espece_save_form" action="{{Route('espece.save')}}" method="POST" enctype="multipart/form-data">
     @csrf
    <div class="card-body pt-0">
        ...
        <div class="mb-10 fv-row">
            ...
            <!--begin::Input-->
                        <input type="Number" name="price" class="form-control mb-2" placeholder="Prix de l'espèce" value="" />
            <!--end::Input-->
