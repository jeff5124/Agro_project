...
<head>
        ...
        <link rel="shortcut icon" href="../../../assets2/img/Icon 66x66.png"/>
...
<div class="d-flex flex-column flex-lg-row flex-column-fluid">
    ...
    <div class="d-flex flex-lg-row-fluid">
        ...
        <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
            <!--begin::Image-->
            <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="../../../assets/media/auth/NetStock_AgroMax3-.png" alt=""/>
            <img class="theme-dark-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20" src="../../../assets/media/auth/NetStock_AgroMax3-.png" alt=""/>
            <!--end::Image-->

            <!--begin::Title-->
            <h1 class="text-gray-800 fs-2qx fw-bold text-center mb-7">
                Bienvenue sur la ferme de l'Afrique
            </h1>
            <!--end::Title-->

            <!--begin::Text-->
            <div class="text-gray-600 fs-base text-center fw-semibold">
               AGROMAX réalise votre aspiration à devenir un investisseur rentable dans le secteur agrobusiness, vous offrant ainsi l'opportunité de contribuer au développement agricole de l'Afrique simplement à partir de votre smartphone ou votre ordinateur. 

                Depuis votre bureau ou votre domicile vous pouvez compter sur la disponibilité et l’expertise de nos centaines d’ingénieurs agronomes praticiens certifiés, nos milliers d’hectares de terres <br/> adaptées et  la haute sécurité de nos infrastructures qui garantissent de minimiser considérablement les risques à faire prendre à votre investissement.
            </div>
            <!--end::Text-->
        </div>
        <!--end::Content-->
