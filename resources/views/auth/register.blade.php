...
<!--begin::Form-->
<form action="{{ route('register') }}" method="POST" class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo1/../demo1/authentication/layouts/overlay/sign-in.html">
    @csrf
    <!--begin::Heading-->
    ...
    <div class="fv-row mb-8">
        <!--begin::Name-->
        <input required type="text" placeholder="Nom et prénoms" name="name" autocomplete="off" class="form-control bg-transparent"/>
        <!--end::Name-->
    </div>
    <div class="fv-row mb-8">
        <!--begin::Email-->
        <input required type="text" placeholder="Email" name="email" autocomplete="off" class="form-control bg-transparent"/>
        <!--end::Email-->
    </div>
    ...
    <div class="fv-row mb-8" data-kt-password-meter="true">
        ...
        <div class="mb-1">
            ...
            <div class="position-relative mb-3">
                <input required class="form-control bg-transparent" type="password" placeholder="Password" name="password" autocomplete="off"/>
        ...
        <div class="text-muted">
           Utilisez 8 carectère ou plus avec des lettres , chiffres et symboles.
        </div>
        <!--end::Hint-->
    </div>
    <!--end::Input group--->
    ...
    <div class="fv-row mb-8">
        ...
        <input required type="text" placeholder="Confirmer mot de passe" name="password_confirmation" type="password" autocomplete="off" class="form-control bg-transparent"/>
        <!--end::Repeat Password-->
    </div>
    <!--end::Input group--->
