...
<head>
	...
	<body class="page page-contacts">
		...
		<!-- start header -->
		<header class="intro  align-items-center  jarallax" data-speed="0.5" data-img-position="50% 32%" style="background-image: url('assets2/img/bg/bg_7.jpg');">

			<div class="pattern" style="opacity: 0.15;"></div>

			<div class="container">
				<div class="intro__text">
					<p class="intro__subtitle">agroMax</p>
		...
		<main role="main">
							...
							<div class="row justify-content-lg-around">
								...
								<div class="col-md-4 col-lg-3">
									<div class="contact__item">
										...
										<p>
											<a href="mailto:contact@agromax.bj">contact@agomax.bj</a>
			...
			<section class="section section--no-pt">
				<div class="container">
					<h4 class="h2">Envoyer un message</h4>

					<form class="js-contact-form" action="#">
						<div class="row">
							<div class="col-md">
								<label class="input-wrp">
									<input class="textfield" type="text" placeholder="nom prénom" name="name" />
								</label>
							</div>
						...
						<button class="custom-btn primary" type="submit" role="button">Envoyer</button>
					...
					<div class="row">
						<div class="col-md-6 col-lg-4">
							<div class="footer__item">
								...
								<p class="footer__copy">© 2023, AgroMax. Tout droit reservé.<br /></p>
							</div>
						</div>
