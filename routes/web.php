...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/domaine/update/{id}', [DomaineController::class, 'update'])->name('domaine.update');
    Route::patch('/domaine/edit', [DomaineController::class, 'edit'])->name('domaine.edit');
    Route::get('/domaine/delete/{id}', [DomaineController::class, 'delete'])->name('domaine.delete');


    Route::get('/espece/index', [EspeceController::class, 'index'])->name('espece.index');
    Route::get('/espece/index2', [EspeceController::class, 'index2'])->name('espece.index2');
    ...
    Route::get('/espece/update/{id}', [EspeceController::class, 'update'])->name('espece.update');
    Route::patch('/espece/edit', [EspeceController::class, 'edit'])->name('espece.edit');
